        ...
        <Container>
          <Row>
            <Col>
              ...
              <p className="text-center animate__animated animate__fadeInUp animate__delay-1s">Temukan Kumpulan Event Event E-Sports Terbaru </p>
            </Col>
          </Row>
          <Row>
              ...
              return (
                <Col key={events.eventID} className="shadow rounded" data-aos="fade-up" data-aos-duration="1000" data-aos-delay={500}>
                  ...
                  <div className="ket d-flex justify-content-between align-items-center px-3 pb-3">
                    <button className="btn btn-danger rounded-1" onClick={() => navigate("/eventdetail/" + events.eventID)}>Detail</button>
                  </div>
                </Col>
              )
            })}
